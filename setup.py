"""
The Google Cloud Platform packer reaper
"""
...
setup(
    ...
    description="reap dangling packer builder machines on GCP",
    ...
    entry_points={
        "console_scripts": [
            "gcp-hashicorp-packer-reaper = gcp_hashicorp_packer_reaper.__main__:main"
        ]
    },
    classifiers=[
